    ...
    return (
        <div className={cn(styles.connect)}>
            <div className="d-flex flex-column flex-lg-row">
                ...
                <div className="d-flex flex-column ml-20 w-100 justify-content-around align-items-lg-center">
                    ...
                    <div className="d-flex justify-content-start">
                        <h5 className="text-bold width-120">ELEMENTS</h5>
                        <div className="font-italic width-160">{`: ${geishaData.elements.toUpperCase()}`}</div>
                    </div>
                    <div className="d-flex justify-content-start">
                        <h5 className="text-bold width-120">RARITY</h5>
                        <div className="font-italic width-160">{`: ${geishaData.rarity.toUpperCase()}`}</div>
                    </div>
                    <div className="d-flex justify-content-start">
                        <h5 className="text-bold width-120">SCORE</h5>
                        <div className="font-italic width-160">{`: ${geishaData.score}`}</div>
                    </div>
                </div>
            </div>
        </div>
